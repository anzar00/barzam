  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>Barzam Resort</h3>
              <p>
                62, Shalimar Ghat, Fore Shore<br>
                Link Road, Shalimar,<br>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Other Links</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="https://hightowncommunities.com">Hightown Communities</a></li>
            </ul>
          </div>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Barzam Resort</span></strong> by <a href="https://hightowncommunities.com"> Hightown Communities</a>
      </div>
      <div class="credits">        
      </div>
    </div>
